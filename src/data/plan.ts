...
/* Credit earned before the degree began: two terms of dual enrolment, taken
 * while still at school. It sits above the first year, folded away — it is
 * done, and it is not part of what the degree still asks for. Those four
 * courses are extra credit rather than requirements, so the 40 and the 120 are
 * untouched by them. */
export const PRE_ENROLLMENT: Year = {
      ...
      courses: [
        {
          ...
          credits: 3,
          classNo: "0417",
          campus: "Dual enrolment",
          modality: "In Person",
          gradeOption: "Graded",
          accent: "teal",
          lastActivity: "Added by advisor, 14 Jun 2024",
        },
        {
          id: "e2",
          code: "ENGL 100",
      ...
      courses: [
        {
          ...
          gradeOption: "Graded",
          accent: "rose",
          lastActivity: "Added by advisor, 2 Dec 2024",
        },
        {
          id: "e4",
          code: "SPAN 101",
